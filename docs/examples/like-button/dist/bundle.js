...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_async_auto__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__error___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__error__);
				...
				autoObj[store.key()].push((cb) => {
					store.handleAction(action, data)
						...
						.catch((error) => {
							...
							if(error instanceof __WEBPACK_IMPORTED_MODULE_1__error__["StoreError"]) {
...
class Globals {
	constructor() {
		this.globals = {
			stores: {},
			defaultDispatcher: new __WEBPACK_IMPORTED_MODULE_0__Dispatcher__["default"]()
		};
	}
...
var _auFlux = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SmartComponent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__SmartComponent__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__error___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__error__);
...
const Dispatcher = __WEBPACK_IMPORTED_MODULE_0__Dispatcher__["default"];
...
const renderError = __WEBPACK_IMPORTED_MODULE_4__error__["default"].renderError;
/* harmony export (immutable) */ __webpack_exports__["renderError"] = renderError;

const SmartComponent = __WEBPACK_IMPORTED_MODULE_2__SmartComponent__["default"];
...
const StoreError = __WEBPACK_IMPORTED_MODULE_4__error__["default"].StoreError;
...
throw new Error("Module parse failed: Unexpected token (36:5)\nYou may need an appropriate loader to handle this file type.\n| \t\t\t\t}\n| \t\t\t\treturn (\n| \t\t\t\t\t<Component\n| \t\t\t\t\t\terrors={errors}\n| \t\t\t\t\t\tloading={loading}");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ids__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__globals__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__error__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__error___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__error__);
...
const build2 = (actions, dispatcher) => {
	...
	class Store {
		...
		handleAction(action, data) {
			if(!actions[action]) {
				return Promise.reject(new __WEBPACK_IMPORTED_MODULE_2__error__["StoreError"]({
			...
			if(!actions[action].run) {
				...
				return Promise.reject(new __WEBPACK_IMPORTED_MODULE_2__error__["StoreError"]({ message, recoverable: false }));
			}
			...
			.catch((error) => {
				let recoverable = false;
				if(error instanceof __WEBPACK_IMPORTED_MODULE_2__error__["StoreError"]) {
					recoverable = error.recoverable;
				}
				else if(error.message && !(error instanceof Error)) {
					error = new __WEBPACK_IMPORTED_MODULE_2__error__["StoreError"](error);
					recoverable = error.recoverable;
				}
